							  ...
							  <div class='form-group'>
									<label class='col-sm-2 control-label'>Akses Transaksi</label>        		
									 <div class='col-sm-4'>
										...
										<input type=checkbox name='piutang[]' value='Y' checked> Piutang </br>
									 </div>
							  </div>
				...
				<div class='box-body'>
						<form method=POST action='$aksi?module=admin&act=update_admin' class='form-horizontal'>
							 ...
							 <div class='form-group'>
									<label class='col-sm-2 control-label'>Akses Data Master</label>        		
									 <div class='col-sm-4'>
										<input type=checkbox name='mpengguna[]' value='Y' "; if($r['mpengguna'] == "Y"){echo"checked";} echo"> Operator </br>
										<input type=checkbox name='mheader[]' value='Y' "; if($r['mheader'] == "Y"){echo"checked";} echo"> Header Struk </br>
										<input type=checkbox name='mjenisbayar[]' value='Y' "; if($r['mjenisbayar'] == "Y"){echo"checked";} echo"> Jenis Pembayaran </br>
							  ...
							  <div class='form-group'>
									<label class='col-sm-2 control-label'>Akses Transaksi</label>        		
									 <div class='col-sm-4'>
										...
										<input type=checkbox name='piutang[]' value='Y' "; if($r['piutang'] == "Y"){echo"checked";} echo"> Piutang </br>
									 </div>
							  </div>
