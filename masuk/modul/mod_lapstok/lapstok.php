    ...
    //                     </table>";
        ...
        //                 </table>";
                        ...
                        <tfoot>
                            <tr>
                                <td colspan='6'><h3><center>Total</center></h3>  </td>
                                <td colspan='3'><h3><strong> Rp. <span id="nilaiStok">0</span>  ,- </strong></h3></td> 
                                <td><a class ='btn btn-danger btn-flat' href='modul/mod_lapstok/SO_barangmacet.php' target='_blank'>STOK <br>OPNAME</a></td> 
                                <td><a class ='btn btn-success btn-flat' href='modul/mod_lapstok/SO_barangmacet_excel.php' target='_blank'>EXPORT <br>TO EXCEL</a></td> 
        ...
        case "edit":
            ...
            $totkeluar = $db->query("select sum(qty_kasirretail) as ttkeluar from trkasir_detail 
                        where kd_barang='$_GET[id]'");
            $keluar=$totkeluar->fetch_array();
        ...
        WHERE kd_barang =$jokul order by trkasir.tgl_trkasir desc " ;
            ...
            <div class='box box-primary box-solid'>
                <div class='box-header with-border'>
                    <h3 class='box-title'><?php echo "Riwayat Penjualan $w (stok = $w2) 
                    dengan total terjual $keluar[ttkeluar]"; ?></h3>
            ...
            $totmasuk = $db->query("select sum(qty_dtrbmasuk) as totmasuk from trbmasuk_detail 
                        where kd_barang='$_GET[id]'");
            $masuk=$totmasuk->fetch_array();


            ?>
            <div class='box box-primary box-solid'>
                <div class='box-header with-border'>
                    <h3 class='box-title'><?php echo "Riwayat Pembelian $w dengan Total pembelian $masuk[totmasuk] "; ?></h3>
                    <div class='box-tools pull-right'>
                        <button class='btn btn-box-tool' data-widget='collapse'><i class='fa fa-minus'></i></button>
                    </div><!-- /.box-tools -->
                </div>
                    ...
                    <table id="example1" class="table table-condensed table-bordered table-striped table-hover">
                        ...
                        while ($q=mysqli_fetch_array($pembelian)) {
                            ...
                            <tr>
                                ...
                                <td align=center>$q[sat_dtrbmasuk]</td>
