...
if ($_GET['action'] == "table_data") {
    ...
    if (!empty($query)) {
        ...
        while ($value = $query->fetch_array()) {
            ...
            $hargabeli = round($brg['hrgsat_barang']);
            $nilaibarang = $hargabeli * $brg['stok_barang'];
    ...
    $json_data = [
        ...
        "totalOm30"         => format_rupiah($totalOm30),
        "totalL30"          => format_rupiah($totalL30),
        "totalStok"         => format_rupiah($totalStok),
        "data"              => $data
    ];
