								...
								$sisa_bayar = format_rupiah($r['sisa_bayar']);
									...
									if($r['carabayar'] == "LUNAS"){
										...
										echo"               
											...
											<td align=right>$jatuhtempo</td>
											<td align=center>$r[carabayar]</td>
											<td align=center>$r[pbf]</td>
											 <td><a href='?module=byrkredit&act=ubah&id=$r[id_trbmasuk]' title='EDIT' class='btn btn-warning btn-xs'>EDIT NON PBF</a>
											 <a href='?module=trbmasukpbf&act=ubah&id=$r[id_trbmasuk]' title='EDIT PBF' class='btn btn-primary btn-xs'>EDIT PBF</a> 
