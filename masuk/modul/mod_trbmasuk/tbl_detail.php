					...
					<table id="example9" class="table table-condensed table-bordered table-striped table-hover" >
						<thead>
							<tr class="judul-table">
								...
								<th style="vertical-align: middle; background-color: #008000; text-align: right; ">HNA+PPN</th>
						...
						include "../../../configurasi/fungsi_rupiah.php";
							...
							$grandnya = format_rupiah($ttlprice['grandnya']);
							   ...
							   ORDER BY id_dtrbmasuk ASC");
								...
								$hna = format_rupiah($r['hnasat_dtrbmasuk']);
								...
								echo "<tr style='font-size: 13px;'>
											 ...
											 <button class='btn btn-xs btn-danger' id='hapusdetail' 
												 data-id_dtrbmasuk='$r[id_dtrbmasuk]' data-id_barang='$r[id_barang]'>
