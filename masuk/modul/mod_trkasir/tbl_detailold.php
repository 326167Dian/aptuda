					...
					<table id="example9" class="table table-condensed table-bordered table-striped table-hover" >
						<thead>
							<tr class="judul-table">
								...
								<th style="vertical-align: middle; background-color: #008000; text-align: right; ">Harga Akhir</th>
		...
		/**					$id_carabayar = $rf['id_carabayar'];
						...
						<legend class='scheduler-border'></legend>
							<div class='col-md-6'>	
											...
											if($stt_aksi == "input_trkasir" && $angsuran==3)
											{	}
											else{
											?>
                                                <div class="box-body table-responsive">
                                                    <table id="example9" class="table table-condensed table-bordered table-striped table-hover">
                                                        ...
                                                        <tr class="judul-table">
                                                            <th style="vertical-align: middle; background-color: #008000; text-align: center; ">No</th>
                                                            <th style="vertical-align: middle; background-color: #008000; text-align: center; ">Pembayaran</th>
                                                            <th style="vertical-align: middle; background-color: #008000; text-align: center; ">Petugas</th>
                                                            <th style="vertical-align: middle; background-color: #008000; text-align: center; ">Waktu</th>
                                                        </tr>
                                                        </thead>
                                                    </table>
                                                </div>
									 ...
									 <div class='col-sm-6'>
										<select name='id_carabayar' id='id_carabayar' class='form-control' style='font-size: 13px; color: #000000; font-weight: bold;'>";
											 if($stt_aksi == "input_trkasir"){
                                                ...
                                                $tampil1=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM trkasir where kd_trkasir='$kd_trkasir'");
                                                $tampil2= mysqli_fetch_array($tampil1);
                                                $tampil3 = $tampil2[id_carabayar];
                                                    $tampil4=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM carabayar where id_carabayar='$tampil3'");
                                                    $tampil5 = mysqli_fetch_array($tampil4);
                                                    echo "<option value=$tampil5[id_carabayar]>$tampil5[nm_carabayar]</option>";
