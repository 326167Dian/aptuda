...
//HEADER 1
$pdf->Line(0.7, 2.7, 21, 2.7); //horisontal bawah

$pdf->Line(0.7, 3.1, 21, 3.1); //judul tabel atas
$pdf->Line(0.7, 3.2, 21, 3.2); //judul tabel bawah
...
$pdf->ln(0.4);
$pdf->SetX(1);
$pdf->Cell(10.5, 0.3, 'Transfer BCA no 0660926062 Rek an Asrul Jamru ', 0, 0, 'L');
...
$pdf->SetFont('Arial','',9);
$pdf->Cell(16.9, 0.3, 'Total Pembayaran: ', 0, 0, 'R');
$pdf->Cell(3, 0.3, format_rupiah($r1['ttl_trkasir']), 0, 1, 'R');

$pdf->ln(0.1);
$pdf->SetX(0.6);
$pdf->SetFont('Arial','',9);
$pdf->Cell(21, 0.6,'Terbilang : '.terbilang($gt).' Rupiah', 0, 0, 'L');
