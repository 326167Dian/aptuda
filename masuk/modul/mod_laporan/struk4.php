...
//HEADER 1
$pdf->Line(0.7, 4.2, 32, 4.2); //horisontal bawah

$pdf->Line(0.7, 5.5, 32, 5.5); //judul tabel atas
$pdf->Line(0.7, 5.6, 32, 5.6); //judul tabel bawah
...
$pdf->Cell(14, 1, 'Nama Barang', 0, 0, 'C');
$pdf->Cell(3, 1, 'Jumlah', 0, 0, 'R');
$pdf->Cell(2, 1, 'Satuan', 0, 0, 'L');
...
while($r2=mysqli_fetch_array($query)){
    ...
    $text1 = substr($r2['nmbrg_dtrkasir'], 0,50);
    $text2 = substr($r2['nmbrg_dtrkasir'], 51,150);
    $text3 = strlen($r2['nmbrg_dtrkasir']);
    
    if ($text3 > 50){
        $pdf->Cell(2, 0.6, $no.'.', 0, 0, 'C');
        $pdf->Cell(14, 0.6, $text1, 0, 0, 'L');
        $pdf->Cell(3, 0.6, $r2['qty_dtrkasir'], 0, 0, 'R');
        $pdf->Cell(2, 0.6, $r2['sat_dtrkasir'], 0, 0, 'L');
        ...
        $pdf->Cell(14, 0.6, $r2['nmbrg_dtrkasir'], 0, 0, 'L');
        $pdf->Cell(3, 0.6, $r2['qty_dtrkasir'], 0, 0, 'R');
        $pdf->Cell(2, 0.6, $r2['sat_dtrkasir'], 0, 0, 'L');
        $pdf->Cell(3, 0.6, format_rupiah($r2['hrgjual_dtrkasir']), 0, 0, 'R');
        $pdf->Cell(3, 0.6, $disc, 0, 0, 'C');
