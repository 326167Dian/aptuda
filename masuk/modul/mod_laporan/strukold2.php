...
$pdf->SetX(0.6);
$pdf->SetFont('Arial','',9);
$pdf->Cell(3.5, 0.3, 'Metode bayar', 0, 0, 'L');
$pdf->Cell(0.5, 0.3, ':', 0, 0, 'R');
$pdf->Cell(3, 0.3, $r1['nm_carabayar'], 0, 0, 'L');

$pdf->SetFont('Arial','',9);
$pdf->Cell(9.5, 0.3, 'Sub Total : ', 0, 0, 'R');
$pdf->Cell(3.5, 0.3, $subtotal, 0, 1, 'R');

$pdf->SetX(0.6);
$pdf->SetFont('Arial','',9);
$pdf->Cell(3.5, 0.3, 'petugas ', 0, 0, 'L');
$pdf->Cell(0.5, 0.3, ':', 0, 0, 'R');
$pdf->Cell(3, 0.3,$r1['petugas'], 0, 0, 'L');

$pdf->Cell(9.5, 0.3, 'Disc Faktur : ', 0, 0, 'R');
$pdf->Cell(3.5, 0.3, format_rupiah($r1['diskon2']), 0, 1, 'R');

$pdf->SetX(0.6);
$pdf->Cell(3.5, 0.3, 'Transfer BSI no Rek 1089057920 an Badiah ', 0, 0, 'L');
$pdf->Cell(13, 0.3, 'Total : ', 0, 0, 'R');
$pdf->Cell(3.5, 0.3, format_rupiah($r1['ttl_trkasir']), 0, 1, 'R');
