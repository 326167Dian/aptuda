...
$pdf = new FPDF("P","cm",array($tinggikertas,29));
...
//HEADER 1
$pdf->Line(0.7, 4.3, 32, 4.3); //horisontal bawah

$pdf->Line(0.7, 5.2, 32, 5.2); //judul tabel atas
$pdf->Line(0.7, 5.3, 32, 5.3); //judul tabel atas
