  ...
  default:
	  ...
	  ?>
			...
			<div class="box box-primary box-solid table-responsive">
				...
				<div class="box-body">
					<a  class ='btn  btn-success btn-flat' href='?module=orders&act=tambah'>TAMBAH</a><div></div><p><p>
		...
		<table id="example1" class="table table-condensed table-bordered table-striped table-hover" >
						...
						<?php $no=1;
								...
								echo "<tr style='font-size: 13px;'> 
                                    ...
                                    if( $pass1 <= "0"){
                                        echo" <td style='background-color:#ff003f;'>$rd[kd_barang]</td> ";                                                            }
                                    elseif ($pass1 > "0" && $pass1 <= "5"){
                                        echo"  <td style='background-color:#EDFF00;'>$rd[kd_barang]</td>"; }
                                    elseif ($pass1 > "0" && $pass1 <= "10"){
                                        echo"  <td style='background-color:#00ff3f;'>$rd[kd_barang]</td>"; }
                                    elseif ($pass1 > "10" ){
                                        echo"  <td style='background-color:#00bfff;'>$rd[kd_barang]</td>"; }

                                    echo " 											
											 <td>$rd[nm_barang]</td>";
									
									if($rd['stok_barang'] == 0 && $q30 > 0){
                                        echo "<td align='right' style='background-color:#ff003f;'>$stok1</td>";  
                                        
                                    } elseif($rd['stok_barang'] > 0 && $rd['stok_barang'] <= ($q30*0.5)){
                                        echo "<td align='right' style='background-color:#EDFF00;'>$stok1</td>";
                                        
                                    } elseif($rd['stok_barang'] <= 0 && $q30 <= 0){
                                        echo "<td align='right' style='background-color:#bcbcbc;'>$stok1</td>";  
                                        
                                    } else {
                                        echo "<td align='right'>$stok1</td>";   
                                    }
		...
		if(nm_supplier == ""){
			...
			$.ajax({
					...
					data: {'id_trbmasuk': id_trbmasuk,
						...
						success: function(data) {
						alert('Proses berhasil !');window.location='media_admin.php?module=orders';
					}
				});
			}
	}
