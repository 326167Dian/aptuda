			...
			<div class="wrapper">
				...
				<header class="main-header">
					...
					<a href="#" class="logo">
						...
						<span class="logo-mini"><marquee><b>APOTEK UDA</b></marquee></span>

						<!-- logo for regular state and mobile devices -->
						<span class="logo-lg"><marquee><b>APOTEK UDA</b></marquee></span>
					</a>
						...
						<ul class="sidebar-menu">
							...
							<li class="treeview">
								...
								<ul class="treeview-menu">
									...
									<?php if ($_SESSION['piutang'] == "Y") { ?><li><a href="?module=piutang"><i class="glyphicon glyphicon-usd"></i> Piutang</a></li><?php } ?>
								    <?php if ($_SESSION['catatan'] == "Y") { ?><li><a href="?module=catatan"><i class='glyphicon glyphicon-pencil'></i> Jurnal Kas Apotek</a></li><?php } ?>
								</ul>
							</li>
