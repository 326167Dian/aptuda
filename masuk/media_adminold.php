	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="#" class="logo">
				...
				<span class="logo-mini"><b><marquee>APOTEK KELUARGA</marquee></b></span>
				
				<!-- logo for regular state and mobile devices -->
				<span class="logo-lg"><b><marquee>APOTEK KELUARGA</marquee></b></span>
			</a>
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview">
						...
						<ul class="treeview-menu">
							...
							<li ><a href="?module=barang&act=barcodebarang"><i class="glyphicon glyphicon-book"></i> Barcode Barang</a></li>
						</ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
					...
					<li class="treeview">
						...
						<ul class="treeview-menu">
							...
							<?php if($_SESSION['penjualansebelum'] == "Y"){ ?><li ><a href="?module=penjualansebelumnya"><i class="glyphicon glyphicon-inbox"></i> Piutang Penjualan </li><?php }?>
                        </ul>
					</li>
